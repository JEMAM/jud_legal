...
export default function TriagemPage() {
  ...
  useEffect(() => {
    ...
    const defaults: Record<string, { defaultVal: string; defaultCredential: string }> = {
      Gemini: { defaultVal: "gemini-2.5-flash", defaultCredential: "" },
      Anthropic: { defaultVal: "claude-3-5-sonnet-20241022", defaultCredential: "" },
      ChatGPT: { defaultVal: "gpt-4o-mini", defaultCredential: "" },
